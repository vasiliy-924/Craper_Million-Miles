...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_cars_brand_normalized'), 'cars', ['brand_normalized'], unique=False)
    ...
    op.create_index(op.f('ix_cars_model_normalized'), 'cars', ['model_normalized'], unique=False)
